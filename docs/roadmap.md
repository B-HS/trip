...
> 최종 갱신: 2026-09-09 · 대응 커밋: aab891f (로컬 dev, 세션 2 후반)
...
| 6 커뮤니티·프로필                           | 미착수(설계 완료)                 | ADR-0028                                                                               |
| 7 인증 확장 등                              | 부분                              | 이름 제거 완료(ADR-0017), Tiptap·YouTube 미착수(ADR-0027), OAuth·이메일 인증·약관 보류 |
