...
> 최종 갱신: 2026-09-10 · 대응 커밋: `9f52a9c`(세션 4 후반 UI 정정) + 4-4e 지구본 확장(ADR-0035, `8b9fbd5` — origin/dev·prod 동기화, prod 배포 `dpl_8P8LFrBSrpJrA7NQQqxW1eNQqvYz` Ready)
...
| 6 커뮤니티·프로필                           | 기본 완료 / 확장 대기(4-5)        | ADR-0028·0032 데이터 계층(마이그레이션 0006) + UI·실측 완료. 범위 밖 기능은 4-5(ADR-0036 예정)로 전부 수용(ADR-0033 §3)                                                          |
